...
exports.processDistributeNftInstructionDiscriminator = [
...
function createProcessDistributeNftInstruction(accounts, args, programId = new web3.PublicKey('FXZzBYS58sVq9KBnVWjduZVpYtwpRAViMdtE8HvwBqR1')) {
    ...
    if (accounts.fanoutForMintMembershipVoucher != null) {
        if (accounts.fanoutMint == null) {
            throw new Error("When providing 'fanoutForMintMembershipVoucher' then 'accounts.fanoutMint' need(s) to be provided as well.");
        }
        keys.push({
