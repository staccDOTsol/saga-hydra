...
export declare const fanoutMembershipVoucherDiscriminator: number[];
/**
...
export declare class FanoutMembershipVoucher implements FanoutMembershipVoucherArgs {
     ...
     */
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<FanoutMembershipVoucher>;
    /**
