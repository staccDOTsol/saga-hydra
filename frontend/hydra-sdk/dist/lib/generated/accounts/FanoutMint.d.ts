...
export declare const fanoutMintDiscriminator: number[];
/**
...
export declare class FanoutMint implements FanoutMintArgs {
     ...
     */
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<FanoutMint>;
    /**
